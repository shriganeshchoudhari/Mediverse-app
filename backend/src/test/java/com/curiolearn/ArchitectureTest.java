...
public class ArchitectureTest {
        ...
        @ArchTest
        public static final ArchRule services_should_not_depend_on_controllers = noClasses().that()
                        .haveSimpleNameEndingWith("Service")
                        .should().dependOnClassesThat().haveSimpleNameEndingWith("Controller");

        @ArchTest
        public static final ArchRule repositories_should_not_depend_on_services_or_controllers = noClasses().that()
        ...
        @ArchTest
        public static final ArchRule common_should_not_depend_on_feature_packages = noClasses().that()
                        .resideInAPackage("..com.curiolearn.common..")
