...
export default function ClinicalSurgeryLabPage() {
  const [selectedModuleId, setSelectedModuleId] = useState<string>("surgery-adv-acute-abdomen-sbo");

  const activeModule = getSurgeryAdvModuleById(selectedModuleId) || SURGERY_ADV_CORE_MODULES[0];
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 pb-20">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-500/20 text-rose-300 border border-rose-500/30 text-xs font-bold uppercase tracking-wider mb-3">
              <Sparkles size={14} /> Virtual Clinical Surgery &amp; Laparoscopic Oncology Laboratory
            </div>
            <h1 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
              🔪 Advanced General, Laparoscopic &amp; Surgical Oncology (SUR-301)
            </h1>
            <p className="text-slate-400 text-sm sm:text-base max-w-2xl mt-2 leading-relaxed">
              Acute Abdomen &amp; Bowel Obstruction (SBO transition point and closed-loop strangulation laparotomy, primary SBP vs secondary peritonitis, Ogilvie syndrome neostigmine), Laparoscopic &amp; Biliary Surgery (Strasberg Critical View of Safety CVS 3 mandatory criteria, Strasberg bile duct injury A-E classification and Roux-en-Y hepaticojejunostomy, Tokyo 2018 acute cholecystitis), Upper &amp; Lower GI Hemorrhage (Forrest classification Ia-III endoscopic dual therapy, subdiaphragmatic pneumoperitoneum, Graham patch omentopexy repair), and Surgical Oncology Lymphatic Staging (Breast SLNB dual mapping Tc-99m/isosulfan blue, Colorectal Total Mesorectal Excision TME with &ge;12 lymph nodes harvest, and Melanoma Breslow thickness wide excision margins).
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 pt-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          <ClinicalSurgeryAdvLabViewer height="560px" />
            ...
            {activeModule.clinicalVignettes.length > 0 && (
              <div className="mt-6 p-5 rounded-xl bg-rose-950/40 border border-rose-800/60">
                <div className="flex items-center gap-2 text-rose-400 text-xs font-bold uppercase tracking-wider mb-2">
                  <Scissors size={16} /> Surgical Case Vignette
                </div>
        ...
        <div className="lg:col-span-4 flex flex-col gap-5">
          <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 shadow-xl">
            <h3 className="text-base font-bold text-white mb-3 flex items-center gap-2">
              <BookOpen size={18} className="text-rose-400" /> SUR-301 Curriculum Units
            </h3>

            <div className="flex flex-col gap-2.5">
              {SURGERY_ADV_CORE_MODULES.map((mod) => {
          ...
          <div className="p-5 rounded-2xl bg-gradient-to-br from-rose-950/60 to-red-950/60 border border-rose-800/40">
            <h4 className="text-sm font-bold text-rose-300 mb-2 flex items-center gap-2">
              <Zap size={16} /> Operative Surgery Rules
            </h4>
            <ul className="text-xs text-slate-300 space-y-2 list-disc list-inside">
              <li>Critical View of Safety: <strong>Clear Calot&apos;s + detach lower 1/3 GB + see ONLY 2 structures</strong>.</li>
              <li>Strangulation Signs: <strong>Fever, peritonitis, tachycardia, leukocytosis, and lactate &gt; 2.5 &rarr; Laparotomy</strong>.</li>
              <li>Perforated Peptic Ulcer: <strong>Free air on CXR &rarr; Emergent Graham patch omentopexy</strong>.</li>
              <li>Rectal Cancer TME: <strong>Sharp dissection in 'holy plane' with CRM &gt; 1 mm &amp; &ge; 12 nodes</strong>.</li>
            </ul>
          </div>
        </div>
      </div>
