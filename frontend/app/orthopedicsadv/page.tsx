...
export default function ClinicalOrthopedicsLabPage() {
  const [selectedModuleId, setSelectedModuleId] = useState<string>("orthopedics-adv-compartment-syndrome");

  const activeModule = getOrthopedicsAdvModuleById(selectedModuleId) || ORTHOPEDICS_ADV_CORE_MODULES[0];
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 pb-20">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-500/20 text-rose-300 border border-rose-500/30 text-xs font-bold uppercase tracking-wider mb-3">
              <Sparkles size={14} /> Virtual Clinical Orthopedic Surgery &amp; Musculoskeletal Oncology Laboratory
            </div>
            <h1 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
              🦴 Advanced Orthopedic Surgery &amp; Musculoskeletal Oncology (ORT-301)
            </h1>
            <p className="text-slate-400 text-sm sm:text-base max-w-2xl mt-2 leading-relaxed">
              Acute Compartment Syndrome (The 6 &apos;P&apos;s, Delta pressure &Delta;P &le; 30 mmHg calculation, and emergent dual-incision 4-compartment leg fasciotomy), Open Fractures &amp; Mangled Extremity (Gustilo-Anderson Types I-IIIc classification, Cefazolin/Gentamicin/Penicillin regimens, and urgent operative debridement), Pediatric Orthopedics (Developmental Dysplasia of the Hip with Pavlik harness, Slipped Capital Femoral Epiphysis SCFE with in situ single cannulated screw fixation and Klein line, Legg-Calv&eacute;-Perthes avascular necrosis), and Musculoskeletal Oncology (Osteosarcoma &apos;sunburst&apos; periosteal reaction and Codman triangle, Ewing sarcoma &apos;onion skinning&apos; t(11;22) translocation, Giant Cell Tumor soap-bubble appearance with Denosumab RANKL inhibitor, and Chondrosarcoma ring-and-arc calcifications).
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 pt-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          <ClinicalOrthopedicsAdvLabViewer height="560px" />
            ...
            {activeModule.clinicalVignettes.length > 0 && (
              <div className="mt-6 p-5 rounded-xl bg-rose-950/40 border border-rose-800/60">
                <div className="flex items-center gap-2 text-rose-400 text-xs font-bold uppercase tracking-wider mb-2">
                  <Activity size={16} /> Orthopedic Surgery Case Vignette
                </div>
        ...
        <div className="lg:col-span-4 flex flex-col gap-5">
          <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 shadow-xl">
            <h3 className="text-base font-bold text-white mb-3 flex items-center gap-2">
              <BookOpen size={18} className="text-rose-400" /> ORT-301 Curriculum Units
            </h3>

            <div className="flex flex-col gap-2.5">
              {ORTHOPEDICS_ADV_CORE_MODULES.map((mod) => {
          ...
          <div className="p-5 rounded-2xl bg-gradient-to-br from-rose-950/60 to-pink-950/60 border border-rose-800/40">
            <h4 className="text-sm font-bold text-rose-300 mb-2 flex items-center gap-2">
              <Zap size={16} /> Clinical Orthopedic Rules
            </h4>
            <ul className="text-xs text-slate-300 space-y-2 list-disc list-inside">
              <li>Compartment Syndrome: <strong>Delta P &le; 30 mmHg = Immediate 4-compartment fasciotomy</strong>.</li>
              <li>Type IIIb Open Fracture: <strong>Cefazolin + Gentamicin + Penicillin G (if soil/farm)</strong>.</li>
              <li>SCFE Rule: <strong>NEVER reduce; emergent in situ single cannulated screw fixation</strong>.</li>
              <li>Osteosarcoma: <strong>Metaphyseal sunburst / Codman triangle producing malignant osteoid</strong>.</li>
            </ul>
          </div>
        </div>
      </div>
