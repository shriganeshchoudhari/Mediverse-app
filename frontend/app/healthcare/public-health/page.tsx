  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <header className="mb-12">
        ...
        <p className="text-xl text-gray-600">Explore Master of Public Health (MPH) and Master of Hospital Administration (MHA) programs.</p>
      </header>
      ...
      <section className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Link href="/healthcare/public-health/mph" className="block group">
            <div className="border border-indigo-200 rounded-xl p-6 bg-white shadow-sm hover:shadow-md transition-shadow group-hover:border-indigo-500">
              <h3 className="text-2xl font-bold text-indigo-700 mb-2">MPH</h3>
              <h4 className="text-lg font-medium text-gray-800 mb-3">Master of Public Health</h4>
              <p className="text-gray-600">Epidemiology, biostatistics, health policy, environmental health, and global health practice.</p>
            </div>
          </Link>
          <Link href="/healthcare/public-health/mha" className="block group">
            <div className="border border-indigo-200 rounded-xl p-6 bg-white shadow-sm hover:shadow-md transition-shadow group-hover:border-indigo-500">
              <h3 className="text-2xl font-bold text-indigo-700 mb-2">MHA</h3>
              <h4 className="text-lg font-medium text-gray-800 mb-3">Master of Hospital Administration</h4>
              <p className="text-gray-600">Hospital operations, financial management, HR, quality (NABH/JCI), and healthcare technology administration.</p>
            </div>
          </Link>
        </div>
      </section>
