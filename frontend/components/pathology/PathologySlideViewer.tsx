...
export const PATHOLOGY_SLIDES: Record<SlideCollectionType, PathologySlide[]> = {
  "cell-injury": [
    ...
    },
    {
      ...
      diagnosis: "Pulmonary Tuberculosis ($Mycobacterium\\text{ }tuberculosis$)",
  ...
  neoplasia: [
    ...
    },
    {
      ...
      etiology: "Chromosomal instability pathway ($APC \\rightarrow KRAS \\rightarrow TP53$) or microsatellite instability ($MSH2/MLH1$).",
